...
export const PREACTIVE_STATUSES: AgreementStatus[] = [
  AGREEMENT_STATUS.DRAFT,
  AGREEMENT_STATUS.PENDING,
];

export const REJECTED_STATUSES: AgreementStatus[] = [
  AGREEMENT_STATUS.CANCELLED,
  AGREEMENT_STATUS.EXPIRED,
];

export const ACTIVE_STATUSES: AgreementStatus[] = [
  AGREEMENT_STATUS.ACTIVE,
  AGREEMENT_STATUS.IN_PROGRESS,
  AGREEMENT_STATUS.COMPLETED,
];

export const FINISH_STATUSES: AgreementStatus[] = [
  AGREEMENT_STATUS.COMPLETED,
  AGREEMENT_STATUS.CANCELLED,
  AGREEMENT_STATUS.EXPIRED,
];
